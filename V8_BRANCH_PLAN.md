...
- [x] Phase 2: Dual-Notation Reconciliation (Aligner, Conflict Resolver, SQLModel Schema, Page Clusterer)
...
- [x] Phase 10: End-to-End Flow Validation (Pipeline integration, Mixed PDF support)
